...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<diff-lcs>.freeze, ["~> 1.6".freeze])
  s.add_runtime_dependency(%q<parser>.freeze, [">= 3.3.0".freeze])
  s.add_development_dependency(%q<mutant>.freeze, ["~> 0.12.4".freeze])
  s.add_development_dependency(%q<mutant-rspec>.freeze, ["~> 0.12.4".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.13".freeze])
  s.add_development_dependency(%q<rspec-core>.freeze, ["~> 3.13".freeze])
